...
from app.service.league_service import (
    get_rank_cutoffs,
    platform_from_region,
)

router = APIRouter(prefix="/league", tags=["league"])


@router.get("/cutoffs", response_model=RankCutoffsResponse)
async def read_rank_cutoffs(
    ...
    """
    Returns Grandmaster and Challenger LP cutoffs for a platform.
